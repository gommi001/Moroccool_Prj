    ...
    <div className={styles.find}>
      ...
      <div className={styles.slider_container}>
        ...
        >
          ...
          <> 
          <SwiperSlide>
            <Link to='/things/cafres/cafecasablanca' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/cafres/cafemeknes' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/cafres/cafefes' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/cafres/caferabat' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/cafres/cafemarrakech' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/cafres/cafeessaouira' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/cafres/cafetangier' style={{color:'#000'}}>           
            <Card
