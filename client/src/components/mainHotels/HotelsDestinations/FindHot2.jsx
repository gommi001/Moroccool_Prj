  ...
  return (
    <div className={styles.find}>
      <div className={styles.heading}>
        <h1>Cafe & Restaurant Destinations in Morocco</h1>
        <div className={styles.text_bg}>
          <p>
            Discover Cafes and Restaurants in many cities
          </p>
        </div>
      </div>
      <div className={styles.slider_container}>
        ...
        >
          ...
          <> 
          <SwiperSlide>
            <Link to='/things/hotels/cafecasablanca' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/hotels/cafemeknes' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/hotels/cafefes' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/hotels/caferabat' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/hotels/cafemarrakech' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/hotels/cafeessaouira' style={{color:'#000'}}>
            <Card
          ...
          <SwiperSlide>
            <Link to='/things/hotels/cafetangier' style={{color:'#000'}}>           
            <Card
