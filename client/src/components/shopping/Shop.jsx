      ...
      {/* First Section */}
        ...
        <div className="best-things-list">
          ...
          <div className="best-thing-item">
            <img src="https://media.istockphoto.com/id/1463115424/photo/colorful-spices-and-dyes-found-at-souk-market-in-marrakesh-morocco.jpg?s=612x612&w=0&k=20&c=Lpipyix23klQYQhBGWl0s4KGNTQ7ZKYxq_Irawpf5fI=" alt="Thing 1" />
            <h3>Traditional Treasures: Moroccan Souks</h3>
            <p>Embark on a journey through Morocco's enchanting souks</p>
          </div>
