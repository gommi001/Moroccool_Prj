...
const AlHoceïma = () => {
  ...
  useEffect(() => {
    fetch(
      'https://api.openweathermap.org/data/2.5/weather?q=Al%20Hoce%C3%AFma&appid=b2747cf8f61c26a33e39ddb183dc29bb&units=metric&includeAstronomy=true'
    )
  ...
  return (
    <div className='Assilah'>
      ...
      <Navbar/>
      <HeroDes
        image="https://images.unsplash.com/photo-1660972288441-18e89c4ec325?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8YWwlMjBob2NlaW1hfGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60"
        city="Al Hoceima"  
      />
