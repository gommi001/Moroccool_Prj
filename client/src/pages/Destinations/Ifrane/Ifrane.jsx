...
const Ifrane = () => {
  ...
  return (
    <div className="ifrane">
      ...
      <Navbar />
      <HeroDes
        image="https://images.unsplash.com/photo-1611358382200-5baf13de1b40?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8aWZyYW5lJTIwbW9yb2Njb3xlbnwwfDB8MHx8fDA%3D&auto=format&fit=crop&w=500&q=60"
        city="Ifrane"
      />

      <GridCat
        link1="/things/cafres/cafeIfrane"
        link2="/events/eventIfrane"
        link3="/things/hotels/hotelIfrane"
      />
      ...
      <div style={{ width: '100%' }}>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d106376.56000706578!2d-7.669394509822682!3d33.57240323277928!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda7cd4778aa113b%3A0xb06c1d84f310fd3!2sIfrane!5e0!3m2!1sen!2sma!4v1682189348085!5m2!1sen!2sma"
          width="100%"
          height="550"
          allowfullscreen=""
          loading="lazy"
