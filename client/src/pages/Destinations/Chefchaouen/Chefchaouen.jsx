...
const Chefchaouen = () => {
  ...
  useEffect(() => {
    fetch(
      'https://api.openweathermap.org/data/2.5/weather?q=Chefchaouen&appid=b2747cf8f61c26a33e39ddb183dc29bb&units=metric&includeAstronomy=true'
    )
  ...
  return (
    <div className="Chefchaouen">
      ...
      <Navbar />
      <HeroDes image="" city="Chefchaouen" />

      <GridCat
        link1="/things/cafres/cafeChefchaouen"
        link2="/events/eventChefchaouen"
        link3="/things/hotels/hotelChefchaouen"
      />
      ...
      {/* Map Section */}
      <h1>Chefchaouen's Map</h1>
      <div style={{ width: '100%' }}>
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d106376.56000706578!2d-7.669394509822682!3d33.57240323277928!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xda7cd4778aa113b%3A0xb06c1d84f310fd3!2sChefchaouen!5e0!3m2!1sen!2sma!4v1682189348085!5m2!1sen!2sma"
          width="100%"
          height="550"
          allowfullscreen=""
          loading="lazy"
